...
with engine.begin() as conn:
    ...
    """), {"id": USER_ID, "email": "test@test.com", "password_hash": "dummy_hash_for_test", "name": "Test User"})
    ...
    config_dict = {
        ...
        "credentials_path": os.getenv("GOOGLE_APPLICATION_CREDENTIALS", "/Users/thedatafirst/ia-poc-final/config/gcp/gcp-key.json")
    }
