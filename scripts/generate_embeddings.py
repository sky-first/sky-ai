...
def generate_embeddings(space_id: str = None, connection_id: str = None, crew_id: str = None):
    ...
    try:
        ...
        query = db.query(TableMetadata).filter(TableMetadata.space_id == space_id)
        if connection_id:
        ...
        total = db.query(EmbeddingRecord).filter(
