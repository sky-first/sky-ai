...
def main():
    ...
    with engine.connect() as conn:
        ...
        if web_dataset_found:
            ...
            print("💡 Você pode usar o script ingest_metadata_for_test.py para ingerir metadados")
            print("   ou criar uma nova conexão apontando para o dataset 'web'")
        else:
            print("\n⚠️  Dataset 'web' não foi encontrado!")
            print("   Verifique se o nome está correto ou se você tem permissão para acessá-lo")
