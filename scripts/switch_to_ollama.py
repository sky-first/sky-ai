...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Switch AI service between OpenAI and Ollama")
    parser.add_argument("--enable", action="store_true", help="Enable Ollama (local models)")
    parser.add_argument("--disable", action="store_true", help="Disable Ollama (use OpenAI)")
