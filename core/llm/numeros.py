...
PALAVRAS_DE_DINHEIRO = {
    "amount", "amounts", "revenue", "receita", "faturado", "faturamento",
    "price", "preco", "preço", "cost", "custo", "value", "valor",
    "salary", "salario", "salário", "mrr", "arr", "ticket",
    "margem", "margin", "lucro", "profit", "despesa", "expense", "billing",
    "total", "subtotal", "balance", "saldo", "spend", "gasto",
}
...
PALAVRAS_QUE_NAO_SAO_DINHEIRO = {
    "id", "ids", "count", "contagem", "quantidade", "qty", "num", "numero",
    "pct", "percent", "percentagem", "percentage", "ratio", "rate", "taxa",
    "year", "ano", "month", "mes", "mês", "day", "dia", "week", "semana",
    "date", "data", "hora", "hour",
}
