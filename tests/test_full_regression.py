...
from core.agents.generic_sql_agent import AgentState, AgentConfig, TableSchema, run_agent_once
...
class TestFullRegression(unittest.TestCase):
    ...
    def test_formatter_state_update(self):
        ...
        self.assertIsInstance(data_in_state, list, "Formatter should convert Arrow to List in state")
